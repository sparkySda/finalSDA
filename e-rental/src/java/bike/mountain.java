 ...
 * @author Plutonianaus
 */
@WebServlet(name = "mountain", urlPatterns = {"/mountain"})
public class mountain extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            String sql = "SELECT * FROM bike where bikeType='Mountain'and bikeStatus='available' ";
        ...
        session.setAttribute("MOUNTAIN", basikal);
        
        response.sendRedirect(request.getContextPath() + "/Mountain_list.jsp");

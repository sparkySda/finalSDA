 ...
 * @author Plutonianaus
 */
@WebServlet(name = "BMX", urlPatterns = {"/BMX"})
public class BMX extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            String sql = "SELECT * FROM bike where bikeType='BMX' and bikeStatus='available' ";
        ...
        session.setAttribute("BMX", basikal);
        
        response.sendRedirect(request.getContextPath() + "/BMX_list.jsp");

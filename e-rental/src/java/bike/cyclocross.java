 ...
 * @author Plutonianaus
 */
@WebServlet(name = "cyclocross", urlPatterns = {"/cyclocross"})
public class cyclocross extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            String sql = "SELECT * FROM bike where bikeType='Cyclocross' and bikeStatus='available'";
        ...
        session.setAttribute("CYCLOCROSS", basikal);
        
        response.sendRedirect(request.getContextPath() + "/Cyclocross_list.jsp");

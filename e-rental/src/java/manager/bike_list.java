 ...
 * @author Plutonianaus
 */
@WebServlet(name = "bike_list", urlPatterns = {"/bike_list"})
public class bike_list extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
        ...
        response.sendRedirect(request.getContextPath() + "/manager_view_bikes.jsp");

 ...
 * @author Plutonianaus
 */
@WebServlet(name = "view_bike_list", urlPatterns = {"/view_bike_list"})
public class view_bike_list extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
        ...
        response.sendRedirect(request.getContextPath() + "/view_bike_only.jsp");
